...
Participating in an immersive coding bootcamp is a significant financial responsibility that many working people do not have the privilege of being able to afford. Even with loans and the advent of the Income Share Agreement, bootcamp is not a realistic option for many aspiring developers. That said, I would argue that there is little, if anything, in the technical curriculum of _any_ bootcamp that cannot be learned for free online. 

So if we can simply go on the internet and obtain all of the learning materials we could ever hope to consume, then what is the point of spending thousands of dollars on a course to learn these things? As a bootcamp graduate, here is my perspective on some of the big things that make a coding bootcamp valuable:

- In an immersive bootcamp you are forced to code every day. You spend anywhere from eight to twelve hours each day learning and building new things. 
- You are assigned mandatory deliverables (homework assignments) that require you to debug issues to completion in order to pass. 
- You are surrounded by like-minded individuals who share the same goal as you. 

If we break the bootcamp experience down to its composite parts, there is no reason why we can't attempt to replicate it on our own. While we can't expect to create a facsimile, we can take concrete steps to put our education and development into our own hands. If bootcamp isn't a realistic option for you, here are some ideas on how to create your own personal bootcamp for free.

## A Note About Starting Small
You absolutely __DO NOT__ have to burn yourself out coding eight hours every single day to get started with coding. I think it's better to start small with one book, one youtube video, or one tutorial and just do a little bit each day.  The most important thing is consistency. As long as you are consistent in your practice, I promise you that your knowledge will grow. 

## Pick Something that Interests You
There are so many different paths to take into the world of programming. Knowing where to start can be very overwhelming. There's web development, machine learning, artificial intelligence, data science, game development, and so on. Keep in mind that what you start with may not end up being what you want to do long term. Your interests will shift and evolve as you progress. The most important thing to do at first is to pick something that interests you enough to motivate you to start. Take some time to shop around. If you're going to go through all of the trouble of learning to code, you may as well pick something that excites you.

## Choose the Right Tool
Once you've found an area that piques your interest, the next big question is generally: which programming language should you learn? There are so many different programming languages to choose from and the choice will largely depend on what you are interested in building. For web development Javascript is a must, for machine learning you can utilize the power of Python, and for game design you have C# and C++. Do some research to find out what people in the field you are interested in actually use. [Here is a chart](https://madnight.github.io/githut/#/pull_requests/2020/4) that ranks programming language popularity by the amount of Github pull requests.
...
### Books
There are many authors and publishers who offer their books free of charge online. A few books I've utilized during my travels are Al Sweigart's [Automate the Boring Stuff with Python](https://automatetheboringstuff.com/), Marijn Haverbeke's [Eloquent Javascript](http://eloquentjavascript.net/), and Aditya Y. Bhargava's [Grokking Algorithms](https://livebook.manning.com/book/grokking-algorithms/about-this-book/). Of course, offering material for free is not common practice for the majority of publishers and authors. If you can't find the book that you're looking for [Zlibrary](https://z-lib.org/) is a fantastic resource. Zlibrary allows you to download over six million books in various formats free of charge. Out of all of the titles I have searched for on Zlibrary, only twice has the book not been available. I cannot recommend this resource enough. Just make sure to show good form and support the authors when you are financially able to do so. 
...
- Many educators on Udemy also offer community Discord servers to accompany their courses. For example, Maximilian Schwarzmüller's [Academind](https://www.udemy.com/user/academind/) has a bustling community of learners.
- [Meetup](https://www.meetup.com/) is full of local and global groups dedicated to various fields in tech. Try searching for your language or field of study and see what comes up. [Junior Developer Happy Hour](https://www.meetup.com/Junior-Developer-Happy-Hour/) is a terrific place to start.

## Build Something
There is a huge difference between learning a programming language and learning how to _use_ that programming language to build things. You can master the syntax of a while loop or a ternary statement inside and out, but what really matters is what you can _do_ with those things.

In bootcamp you are assigned daily deliverables that must be completed in order to qualify for graduation. These assignments are so important because they give you practice in using code to actually create things. You should push yourself to build something new each day, even if it is something small. You do not have to build something groundbreaking. Just keep it simple and focus on the application of what you have learned that day. 

In bootcamp you are also assigned larger projects that give you the opportunity to put everything you have learned up until that point together. Once a month spend a week on a project combining the things you have learned. Just like with your deliverables, these do not need to be masterpieces. Perfect is the enemy of good. Just aim to put the things you have learned up until that point together and build something cohesive that brings you joy. 
...
When you hit bugs, which you inevitably will, utilize Google, your learning materials, and your support network to debug the problem until it is fixed. First and foremost: __Google early and Google often.__ Ninety-nine times out of a hundred someone else on the internet has run into the same problem that you are experiencing. Whether in a Stack Overflow post or a technology's official documentation, the solution to your problem is most likely a Google search or two away. 
